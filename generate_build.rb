...
libadb = compile(expand("core/adb", adbfiles), "-D_GNU_SOURCE -DADB_HOST=1 -Icore/include -Icore/base/include -Icore/adb -Icore/libcrypto_utils/include -Iboringssl/include -Imdnsresponder/mDNSShared -Ibase/libs/androidfw/include -Inative/include")
...
libandroidfw = compile(expand("base/libs/androidfw", androidfwfiles), "-Ibase/libs/androidfw/include -Icore/libutils/include -Icore/libsystem/include -Icore/liblog/include -Icore/libziparchive/include -Icore/base/include -Inative/include -Icore/libcutils/include")
...
libcorebase = compile(expand("core/base", corebasefiles), "-DADB_HOST=1 -Icore/base/include -Icore/include")
...
link("adb", libandroidfw + liblog + libcutils + libadbd + libutil + libmdnssd + libadb + libzip + libcorebase + libdiagnoseusb + libcrypto + boringssl, "-lpthread -lusb-1.0 -lz")
link("fastboot", libsparse + libzip + libcutils + liblog + libutil + libcorebase + libext4 + f2fs + libselinux + libsepol + libfastboot + libdiagnoseusb + liblp + boringssl, "-lz -lpcre2-8 -lpthread -ldl")
...
link("mke2fs.android", mke2fs + libext2fs + libsparse + libcorebase + libzip + liblog + libutil, "-lpthread -lz -luuid")
...
link("e2fsdroid", e2fsdroid + libext2fs + libsparse + libcorebase + libzip + liblog + libutil + libselinux + libsepol + libcutils, "-lz -lpthread -lpcre2-8")
...
link("ext2simg", ext2simg + libext2fs + libsparse + libcorebase + libzip + liblog + libutil, "-lz -lpthread")
