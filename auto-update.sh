...
URL="https://api.github.com/repos/tinkernels/doh-relay/tags"
REPO="https://github.com/tinkernels/doh-relay.git"
...
sed -i "s/pkgver=.*/pkgver=$tag_name.r$git_count.$git_date.$git_hash/" PKGBUILD || \
