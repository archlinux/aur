...
URL="https://api.github.com/repos/ameshkov/dnslookup/releases"
...
tag_name=$(jq -r .tag_name < $temp_file | sed "s/^v//")
...
tarball_url="https://github.com/ameshkov/${pkgname}/archive/refs/tags/v${tag_name}.tar.gz"
