...
_JAVA_OPTIONS= XMODIFIERS= "${JVM}" \
    ...
    -Xmx256m \
    -Xincgc \
    -cp DroidAssault.jar:maps.jar:music.jar:fx-mono.jar:fx-stereo.jar:images.jar:gfx.jar:fonts.jar:data-hib.jar:common-cp-java6.jar:common.jar:spgl-lite.jar:lwjgl.jar:lwjgl_util.jar:gson.jar:jinput.jar:ogg.jar:gamecommerce.jar:steampuppy-public.jar:remote.jar \
