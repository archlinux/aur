...
EXEC_PATH="c:/Program Files (x86)/wenku-pc/百度文库_105.exe"
EXEC_FILE="${WINEPREFIX}/drive_c/Program Files (x86)/wenku-pc/百度文库_105.exe"
START_SHELL_PATH="/opt/deepinwine/tools/run_v4.sh"
UPDATEAPP_INSTALLER="BaiduWenku"
UPDATEAPP_VER="1.1.8"
UPDATEAPP_INSTALLER_PATH="c:/Program Files (x86)/wenku-pc/${UPDATEAPP_INSTALLER}-${UPDATEAPP_VER}.exe"
export MIME_TYPE=""
