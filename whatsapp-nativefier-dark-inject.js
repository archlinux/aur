...
(function() {var css = [
	...
	"    --version: \"Dark-WhatsApp USo-Lite v2.3.3 — March 27th, 2020\";",
	"    --message: \"Another is out, report broken things on GitHub so that we can fix them. Also, thanks for all the recent *bad* reviews! 🎉 🥳 I published an important update about my userstyles, please read it:  \";",
	...
	"    fill: var(--accent) !important;",
	"  }",
	"  span[class][data-icon *= \"in-green\"] path[fill = \"#09D261\"] {",
	...
	"    fill-opacity: 0.55;",
	"  }",
	"  span[class][data-icon = \"down\"] path {",
	"    fill: var(--white) !important;",
	"  }",
	...
	"    fill: var(--red) !important;",
	"  }",
	"  #side > header + span[class] ._2t3oV [data-icon ^= \"alert-\"] path {",
	"    fill: var(--red);",
	"  }",
	...
	"    color: var(--lighter) !important;",
	"  }",
	"  ._1-iDe .copyable-area .MS-DH .tail,",
	"  ._1-iDe .copyable-area .MS-DH .tail > div[class] {",
	"    border-radius: 7.5px !important;",
	"  }",
	"  ._1-iDe .copyable-area .MS-DH .tail-container {",
	...
	"    color: var(--light) !important;",
	"  }",
	"  .message-in > div:not(._1rK-b),",
	"  .message-out > div:not(._1rK-b) {",
	...
	"    color: inherit;",
	"  }",
	"  .message-in ._1rK-b :not(.tail) > div > ._2Hp95._1X6iJ ._2R8MP,",
	"  .message-out ._1rK-b :not(.tail) > div > ._2Hp95._1X6iJ ._2R8MP {",
	"    border-radius: 7.5px;",
	"  }",
	"  .message-in ._1lxsr,",
	"  .message-out ._1lxsr,",
	...
	"    border-top-color: var(--msg-l);",
	"    border-right-color: var(--msg-l);",
	"  }",
	"  .message-in [role] > span[role = \"button\"] + span {",
	"    color: var(--light) !important;",
	"  }",
	"  .message-in > div > span:last-child > div[style]:not(._1UyGF),",
	"  ._1i1U7.jZ4tp {",
	...
	"    opacity: 0.8;",
	"  }",
	"  .message-out > div:not(._1rK-b) > div:not(._19l4G) {",
	"    color: var(--light) !important;",
	"    background-color: var(--msg-r) !important;",
	"  }",
	"  .message-out ._19l4G:not(#z) > :first-child:not(:last-child) {",
	"    color: var(--light) !important;",
	"    background-color: var(--darken) !important;",
	"    box-shadow: inset 0 0 0 1px var(--darker), var(--bshadow);",
	"  }",
	"  .message-out ._19l4G:not(#z) > :first-child:not(:last-child)::after {",
	"    border-left-color: var(--darker) !important;",
	"  }",
	"  .message-out ._19l4G:not(#z) > [role = \"button\"] {",
	"    border-color: var(--shadow) !important;",
	"    background-color: var(--red) !important;",
	"  }",
	"  .message-out ._19l4G:not(#z) > [role = \"button\"] path[fill = \"#FFF\"] {",
	"    fill: var(--white) !important;",
	"  }",
	...
	"    border-top-color: var(--msg-r);",
	"    border-left-color: var(--msg-r);",
	"  }",
	...
	"  }",
	"  .message-out > div > span:nth-last-child(2) > div[style].jZ4tp {",
	"    background: linear-gradient(90deg, var(--t), var(--msg-r) 80%) !important;",
	"  }",
	"  .message-out ._1iJeo {",
	"    background-color: var(--dark) !important;",
	...
	"    background-color: var(--accent) !important;",
	"  }",
	"  #main > footer ._1vDUw ._1qUma > :not(._2wn58) {",
	"    color: var(--lighter) !important;",
	"  }",
	"  #main > footer ._1vDUw ._1qUma > :not(._2wn58):not(:hover) path {",
	"    fill: var(--lighter);",
	"  }",
	"  #main > footer ._1vDUw ._1qUma > :not(._2wn58):hover,",
	"  #main > footer ._1vDUw ._1qUma ._2wn58 {",
	"    color: var(--light) !important;",
	"  }",
	...
	"    background-color: var(--darken) !important;",
	"  }",
	"  #main > footer .rstyJ > div:first-child:not(#z) div[role] {",
	"    background-color: var(--darken) !important;",
	"  }",
	"  .quoted-mention {",
	"    color: var(--lighter) !important;",
	"  }",
	"  #main > footer .rstyJ > div:first-child:not(#z) [class *= \"bg-color\"] + [dir] {",
	"    border-radius: 0 6px 6px 0 !important;",
	"    box-shadow: inset 0 0 0 1px var(--darker);",
	"  }",
	"  #main > footer .rstyJ > div:first-child:not(#z) .EebcE + div {",
	"    box-shadow: inset 0 0 0 1px var(--darker);",
	"  }",
	...
	"    box-shadow: 0 -1px var(--darker) !important;",
	"  }",
	"  #main > footer .Uukb4::before {",
	"    content: none;",
	"  }",
	"  #main > footer .Uukb4 .J6TrU {",
	"    color: var(--light) !important;",
	"    border-color: var(--darker) !important;",
	"    background-color: var(--dark) !important;",
	"  }",
	"  #main > footer .Uukb4 .J6TrU._1g_fA,",
	"  #main > footer .Uukb4 .J6TrU:hover {",
	"    background-color: var(--darken) !important;",
	"  }",
	"  #main > footer .Uukb4 ._3SW-z {",
	"    color: var(--lighter) !important;",
	"  }",
	"  ._1M0Ew {",
	"    color: var(--lighter) !important;",
