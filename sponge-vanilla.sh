...
declare -r myname="sponge-vanilla"
declare -r game="sponge-vanilla"
...
[[ -n "${GAME_USER}" ]]    && declare -r GAME_USER=${GAME_USER}       || GAME_USER="sponge-vanilla"
[[ -n "${MAIN_EXECUTABLE}" ]] && declare -r MAIN_EXECUTABLE=${MAIN_EXECUTABLE} || MAIN_EXECUTABLE="sponge-vanilla_server.jar"
