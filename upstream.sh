...
pkg_detect_latest() {
	local api_url="https://api.github.com/repos/xifan2333/ftty/releases/latest"
...
pkg_get_update_params() {
	local version="$1"
	local base_url="https://github.com/xifan2333/ftty/releases/download/v${version}"
	local filename_x86_64="ftty-${version}-x86_64-unknown-linux-gnu.tar.gz"
...
pkg_update_files() {
	...
	local base_url="${url%/*}"
	local url_x86_64="${base_url}/ftty-${pkgver}-x86_64-unknown-linux-gnu.tar.gz"
