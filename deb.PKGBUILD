...
#'deb.PKGBUILD')
sha256sums=('SKIP'
            '089925a8f4ec36be36163515726ac26bc6373ba10f101295fd60673554ba3465')
#            'SKIP'
#            'SKIP')
...
ln -rTsf ${_pkgdir}/opt/skywire/bin/${_pkgname}-visor ${_pkgdir}/usr/bin/${_pkgname}
...
install -Dm644 ${srcdir}/${_scripts}/${_pkgname}-autoconfig.service ${_pkgdir}/${_systemddir}/${_pkgname}-autoconfig.service
install -Dm644 ${srcdir}/${_scripts}/${_pkgname}-autoconfig-remote.service ${_pkgdir}/${_systemddir}/${_pkgname}-autoconfig-remote.service
