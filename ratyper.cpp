...
public:
    RASCIIConfig() {
        ...
        config_dir = std::string(home_dir) + "/.config/ratyper";
        config_file = config_dir + "/ratyper.conf";
    ...
    void create_default_config() {
        ...
        file << "# Add ASCII arts between ###ART_START### and ###ART_END### markers\n";
        file << "# Example:\n";
        file << "###ART_START###\n";
        file << "# Your art here\n";
        file << "###ART_END###\n";
...
void print_help() {
    std::cout << "RATYPER - Random ASCII Art Display\n\n";
    std::cout << "Usage:\n";
    std::cout << "  ratyper          - Show random ASCII art\n";
    std::cout << "  ratyper --list   - List all ASCII arts\n";
    std::cout << "  ratyper --help   - Show this help message\n";
    std::cout << "  ratyper --config - Show config file path\n";
    std::cout << "\nConfiguration file: ~/.config/ratyper/ratyper.conf\n";
