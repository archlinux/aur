...
"# Конфигурация cliphist-cpp\n"
"# Строки, начинающиеся с #, игнорируются.\n"
"# После изменения настроек перезапустите GUI и демон:\n"
"#   systemctl --user restart cliphist-cpp.service\n"
"\n"
"[history]\n"
"# Сколько последних записей хранить в истории буфера обмена\n"
"max_history = 150\n"
"# Максимальный размер одной текстовой записи, в килобайтах\n"
"max_text_size_kb = 512\n"
"# Максимальный размер одного изображения, в мегабайтах\n"
"max_img_size_mb = 64\n"
"\n"
"[daemon]\n"
"# Интервал опроса буфера обмена, в миллисекундах.\n"
"# Меньше значение — быстрее реакция, но выше нагрузка на CPU.\n"
"poll_interval_ms = 400\n"
"\n"
"[appearance]\n"
"# Размер окна истории буфера обмена, в пикселях\n"
"window_width = 560\n"
"window_height = 500\n"
"# Акцентный цвет интерфейса (рамки, подсветка, бейджи), в HEX\n"
"accent_color = #3d22ef\n"
"# Цвет фона окна, в HEX\n"
"background_color = #070711\n"
"# Шрифт интерфейса (список через запятую, как в CSS font-family)\n"
"font_family = \"JetBrainsMono Nerd Font\", \"JetBrains Mono\", \"Fira Code\", monospace\n"
"# Базовый размер шрифта, в пикселях\n"
"font_size = 13\n"
"# Количество строк предпросмотра для текстовых записей (от 1 до 3)\n"
"preview_lines = 3\n"
"# Размер миниатюр изображений, в пикселях\n"
"thumbnail_width = 180\n"
"thumbnail_height = 80\n"
"\n"
"[general]\n"
"# Язык интерфейса: auto (определять по локали системы), en, ru\n"
"language = auto\n";
