# EVERY COMMIT SHOULD CONTAIN PKGBUILD FILE
PKG_NAME := hiddify-next-appimage
...
install: update
# don't clean build since git clone is time-comsuming
# env all_proxy=http://127.0.0.1:7890 makepkg -si --clean
	env all_proxy=http://127.0.0.1:7890 makepkg -si
