# Maintenance helpers for the ruroco-client AUR package.
#
...
PKG      := ruroco-client
KEYWORDS := port-knocking single-packet-authorization fwknop udp remote-command firewall ssh rust cli
