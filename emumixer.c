...
/* stuff added to sound/core/control.c in ossilator patches + declations required to compile them */

enum snd_ctl_add_mode { CTL_ADD_EXCLUSIVE, CTL_REPLACE, CTL_ADD_ON_REPLACE };
...
\
/* end of stuff added to sound/core/control.c in ossilator patches */
