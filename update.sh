...
latest_version=$(curl -Is "https://github.com/kcat/openal-soft/releases/latest" | grep "location" | head -1 | sed "s#.*tag/##g" | tr -d "\r")
echo "Latest OpenAL Soft version: ${latest_version}"
