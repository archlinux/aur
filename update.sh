...
REPO_URL="https://github.com/tanghaibao/jcvi"
PKGNAME="jcvi"

echo "==> Checking for new version..."

LATEST_TAG=$(curl -s https://api.github.com/repos/tanghaibao/jcvi/tags | grep -oP '"name": "\K(.*)(?=")' | head -1)
...
rm /tmp/$PKGNAME-$LATEST_VERSION.tar.gz
