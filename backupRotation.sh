...
<body>
    ...
    <p>
        <pre>
$(tree "$target_path" | sed "s/(${target_daily_file_name}|${target_weekly_file_name}|${target_monthly_file_name})${target_file_extension}/─ <span style="font-weight:bold">${target_daily_file_name}${target_file_extension}<\\/span>/")
        </pre>
    </p>
